...
export const CHAPTER_ONE_LEVELS: LevelConfig[] = [
  ...
  },
  {
    ...
    playerHp: 12,
    unlockedMechanics: ['invite', 'compare', 'player_draw', 'heat', 'resonance', 'skills', 'soul_redeem'],
    useRandomAfterFixedRounds: true,
  ...
  },
  {
    ...
    playerHp: 12,
    unlockedMechanics: ['invite', 'compare', 'player_draw', 'heat', 'resonance', 'skills', 'items', 'soul_redeem'],
    useRandomAfterFixedRounds: true,
  ...
  },
  {
    ...
    playerHp: 12,
    unlockedMechanics: ['invite', 'compare', 'player_draw', 'heat', 'resonance', 'skills', 'items', 'soul_redeem', 'enemy_passives'],
    useRandomAfterFixedRounds: true,
  ...
  },
  {
    ...
    unlockedMechanics: ['invite', 'compare', 'player_draw', 'heat', 'resonance', 'skills', 'items', 'soul_redeem', 'enemy_passives', 'boss'],
    useRandomAfterFixedRounds: true,
    bossConfig: {
      enemyId: 'werewolf',
